...
Many Americans are aware that college sports teams coaches are among the highest paid employees on college and university rosters, but less is known about the salaries of college-level sports coaches. In this project, we examined institution-level data from the Equity in Athletics Survey, sample year 2017-2018, from the U.S. Department of Education Office of Postsecondary Education [-@EADA2018]. In this analysis we investigated potential predictors for salaries of sports team head coaches at four-year colleges and universities in the United States. This project focuses on differences of salaries between head coaches of male teams and female teams; salary diversity between division classifications; and the effects of the number of student participants (i.e. athletes) on head coach salaries. Classifications are defined according to the athletic association (such as NAIA, NCAA, etc) and divisions or subdivisions where applicable (e.g. NCAA Division I-FBS, NCAA Division I-FCS, NCAA Division I without football).
...
Overall, we examined whether school classification and gender of the teams affect head coach salaries. To do this, we first tested the equality of variances of head coach salaries for male teams versus female teams: \(H_0\): \(\sigma^2_{male} = \sigma^2_{female}\); \(H_1\): \(\sigma^2_{male} \ne \sigma^2_{female}\). As noted in the Results section below, we concluded that this data does not meet the assumption of equal variances for parametric testing of means, so we went on to test the equality of the medians: \(H_0\): \(M_{male} = M_{female}\);
...
<!-- NOTE: These are 7 hypotheses, but note email chain for eventually getting rid of 2 -->
